...
public class AdapterAnimation extends RecyclerView.Adapter<AdapterAnimation.ViewHolder>{
    ...
    public AdapterAnimation(Context mContext, List<MovieModel> items, AdapterMovie.onSelectData onSelectData) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterAnimation.ViewHolder(view);
    }
